const TRANSLATIONS = {
  'pt-br': {
    ...
    contact_lead: `Vamos conversar ? <br><br>
        <i class="fa-duotone fa-envelope main-accent"></i> <span class="fw-bold">prsousa730@gmail.com</span>`,

    contact_available: "Disponível para:",
    contact1: `<i class="fa-duotone fa-briefcase main-accent"></i> Freelance, CLT full-time remote, PJ full-time remote`,

    footer: "© 2026 Pablo Sousa"
  },
  ...
  'en-us': {
    ...
    banner_intro: `Hello! I'm Pablo, specialist in robust systems, security, integrations, cloud and automation.
          Focus on results, efficiency and scalability.<br><br>
          <span class="fw-bold main-accent">16 years delivering high-impact solutions for companies.</span><br><br>`,

    banner_list1: `<i class="fa-solid fa-square-check diffs-icon"></i>Fullstack`,
    banner_list2: `<i class="fa-solid fa-square-check diffs-icon"></i>Always helping others`,

    value1: `<i class="fa-duotone fa-shield-halved"></i> Security is priority`,
    ...
    diffs3: `<i class="fa-duotone fa-people-group diffs-icon"></i> Agile cooperation between dev, ops and business teams`,
    ...
    contact_lead: `Let's talk? <br><br>
        <i class="fa-duotone fa-envelope main-accent"></i> <span class="fw-bold">prsousa730@gmail.com</span>`,

    contact_available: "Available for:",
    contact1: `<i class="fa-duotone fa-briefcase main-accent"></i> Freelance, full-time remote CLT, full-time remote PJ`,
...
// Opcional: carregar idioma padrão (pt-br)
translatePage('pt-br');
